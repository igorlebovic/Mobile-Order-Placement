...
from speeqeweb.checkout.models import Order
from speeqeweb.settings import DEBUG
import datetime
import re
...
class CheckoutForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['shipping_city'].widget.attrs['size'] = '30'
        self.fields['shipping_state'].widget.attrs['size'] = '3'
        self.fields['shipping_zip'].widget.attrs['size'] = '6'
        
        self.fields['billing_city'].widget.attrs['size'] = '30'
...
class CheckoutFormCash(forms.ModelForm):
    """ checkout form class just for cash orders """
    
    class Meta:
        model = Order
        exclude = ('status','ip_address','user','transaction_id','billing_zip','venue_id','phone','email','billing_name')