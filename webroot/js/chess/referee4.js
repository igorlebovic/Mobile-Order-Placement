var Referee = {
    ...
    on_presence: function (pres) {
        ...
        if (domain === Referee.MUC_SERVICE) {
            ...
            if (type === "unavailable") {
// temporarily removed unregistration
        ...
        if (!Referee.presence[Strophe.getBareJidFromJid(from)]) {
            ...
            if (child.length > 0) {
                ...
                case 'response_to_merchant':
                    Referee.on_response_to_merchant(iq, id, from, child);
                    break;
    ...
    on_waiting: function (id, from, elem) {
                ...
                $('#waiting tbody').append(
                        ...
                        ($(this).attr('jid') === Referee.connection.jid ?
                         "" :
                         "<input type='button' class='accept_order' id='accept_order' " +
...
//                alert(game);
                Referee.connection.send(
                    $msg({to: from, type: "chat"})
                        ...
                        .c('response_confirmation', {xmlns: Referee.NS_TOETEM}));
...
$(document).ready(function () {
    ...
    if (strHref.indexOf("#") > -1) {
        ...
        $(document).trigger('referee_connect', {
            jid: 'aerosmile@kangoria.com/bot',
            password: 'aerodiet'
        });
    }
