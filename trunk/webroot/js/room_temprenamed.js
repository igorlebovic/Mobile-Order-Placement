...
function init() {
  $.each(verticals, function(i) {
    var li = '<li><a class="vertical" onclick="javascript:show_vertical(' + i + ')">' + 
             '<img src="/images/img/cat-' + verticals[i] + '18x.png"> '+
             verticals[i] + '</a></li>'
...
//  var li2 = '<li><div id="chat"><div id="chatWindow_chatpane" class="direction-up"><div id="post_template">5354</div></div></li>'
            ...
            '<div id="chatpane_post" class="post">' +
              '<div class="postmark">' +
                '<div class="message_block">' +
                    ...
                    '01/01/08' +
                    '<!--Message Time Stamp (dont change id)-->' +
                    '</small>' +
                    '</p>' +
                    '<p class="user-info">' +
